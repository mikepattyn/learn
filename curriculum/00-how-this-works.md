...
These lessons are small on purpose.

- One step on screen. The rest of the mountain stays folded.
- You tick a step when you did it. Nothing grades you.
- Progress lives on the device that is reading. It does not expire.
- Motion stays still unless you turn on a little.
- The optional timer is eight minutes and silent. When it ends it only says: pause if you want. The step will wait.
